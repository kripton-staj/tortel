...
def extract_description(soup):
    ...
    class_names = [{"id": "product_omschrijving"}, {"class": "product data content"},
                   ...
                   {"class": "pd-info__usp-list"}, {"class": "product-description"}, {"class": "product-info__text"},
                   {"id": "product-page"}, {"class": "f-productDetails-table"}, {"id": "tab-description"},
                   {"class": "mxd-page-section"}, {"class": "product-collateral"}]
...
def extract_breadcrumbs(soup):
    ...
    brd_array = [{"class": "breadcrumbs__link"}, {"class": "breadcrumb"}, {"id": "breadcrumb"},
                 ...
                 {"class": "c-breadcrumb"}, {"class": "nav nav-tabs"}, {"class": "woocommerce-breadcrumb"},
...
def extract_specifications(soup):
    ...
    spec_class_names = [{"class": "specifications"}, {"class": "specificaties"}, {"id": "description-collapse"},
                        ...
                        {"class": "feature-benefit__text-wrap"}, {"class": "product__specs"},
                        {"class": "slot slot--seperated slot--seperated--has-more-content js_slot-specifications"},
                        {"class": "v-card__text pa-2 product-specifications__text"}, {"class": "std"},
                        {"id": "Characteristics"}]
